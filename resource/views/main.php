...
<head>
    <title><?= @$title ? $title : "Administrator" ?> | <?= Config::get('app.title') ?></title>
    <meta charset="utf-8" />
    ...
    <link href="/admin_assets/css/style.<?= isset($_SESSION['theme']) ? $_SESSION['theme'] . '.' : null ?>bundle.css" rel="stylesheet" type="text/css" />
...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
                        ...
                        <div class="app-navbar align-items-center flex-shrink-0">
                                                ...
                                                <div class="scroll-y mh-200px mh-lg-350px">
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="/admin_assets/media/avatars/300-6.jpg" alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="/admin_assets/media/avatars/300-2.jpg" alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                        <div class="d-flex flex-column justify-content-start fw-bold">
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="/admin_assets/media/avatars/300-9.jpg" alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                        <div class="d-flex flex-column justify-content-start fw-bold">
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="/admin_assets/media/avatars/300-14.jpg" alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                        <div class="d-flex flex-column justify-content-start fw-bold">
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="/admin_assets/media/avatars/300-11.jpg" alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                        <div class="d-flex flex-column justify-content-start fw-bold">
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px" src="/admin_assets/media/svg/brand-logos/volicity-9.svg" alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px" src="/admin_assets/media/svg/brand-logos/tvit.svg" alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px" src="/admin_assets/media/svg/misc/infography.svg" alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px" src="/admin_assets/media/svg/brand-logos/leaf.svg" alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px" src="/admin_assets/media/svg/brand-logos/tower.svg" alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                            ...
                            <div class="app-navbar-item ms-2 ms-lg-4">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                                    <!--begin::Heading-->
                                    <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('/admin_assets/media/misc/header-dropdown.png')">
                                        <!--begin::Title-->
                            ...
                            <div class="app-navbar-item ms-2 ms-lg-4">
                                <!--begin::Menu wrapper-->
                                <a href="#" class="btn btn-icon btn-outline btn-primary fw-bolder" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                                    <span class="fs-5">3</span>
                                </a>
                                <!--begin::Menu-->
                                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                                    <!--begin::Heading-->
                                    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('/admin_assets/media/misc/header-dropdown.png')">
                                        <!--begin::Title-->
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                    ...
                    <div class="app-sidebar-menu app-sidebar-menu-arrow hover-scroll-overlay-y my-5 my-lg-5 px-3" id="kt_app_sidebar_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_toolbar, #kt_app_sidebar_footer" data-kt-scroll-offset="0">
                        ...
                        <div class="menu menu-column menu-sub-indention fw-bold" id="#kt_sidebar_menu" data-kt-menu="true">
                            ...
                            <div class="menu-item">
                                <a href="<?= Route::name('admin.home.index') ?>" class="menu-link">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg" style="display: none; overflow: hidden;" kt-hidden-height="87">
                                    <div class="menu-item">
                                        <a class="menu-link" href="<?= Route::name('admin.content.index') ?>">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="<?= Route::name('admin.content.create') ?>">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg" style="display: none; overflow: hidden;" kt-hidden-height="87">
                                    <div class="menu-item">
                                        <a class="menu-link" href="<?= Route::name('admin.menu.index') ?>">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title"><?= _l('admin.list') ?></span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="<?= Route::name('admin.menu.create') ?>">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title"><?= _l('admin.add') ?></span>
                            ...
                            <div class="menu-item">
                                <a href="<?= Route::name('admin.themes.index') ?>" class="menu-link">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <div class="menu-item">
                                <a href="<?= Route::name('admin.themeEditor.index') ?>" class="menu-link">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="/good/apps/projects/project.html" class="w-30px me-3" src="/admin_assets/media/svg/files/doc.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="/good/apps/projects/project.html" class="w-30px me-3" src="/admin_assets/media/svg/files/css.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
    ...
    <div class="modal fade" tabindex="-1" id="ask-modal">
